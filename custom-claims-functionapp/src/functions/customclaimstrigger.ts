...
export async function customclaimstrigger(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
...
app.http('customclaimstrigger', {
    methods: ['GET', 'POST'],
    authLevel: 'anonymous',
    handler: customclaimstrigger
});
